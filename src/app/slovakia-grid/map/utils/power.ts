...
export default function powerStyle(): LayerSpecificationWithZIndex[] {
  return [
    // 400kV Transmission lines
    {
      ...
      paint: {
        "line-width": [
          ...
          0.8,
          18,
          ["case", ["==", ["get", "usage"], "transmission"], 10, 8],
        ],
    ...
    // 220kV Transmission Lines
    {
      ...
      paint: {
        "line-width": [
          ...
          0.6,
          18,
          ["case", ["==", ["get", "usage"], "transmission"], 8, 6],
        ],
    ...
    // 110kV Transmission Lines
    {
      ...
      paint: {
        "line-width": [
          ...
          0.5,
          18,
          ["case", ["==", ["get", "usage"], "transmission"], 6, 5],
        ],
    ...
    // 22kV Transmission Lines
    {
      ...
      paint: {
        "line-width": [
          ...
          0.3,
          18,
          ["case", ["==", ["get", "usage"], "transmission"], 4, 3],
        ],
    ...
    // Nuclear power plants - Labels
    {
      zorder: 270,
      id: "power-plant-nuclear-labels",
    ...
    // Hydro power plants - Labels
    {
      zorder: 270,
      id: "power-plant-hydro-labels",
      type: "symbol" as const,
      source: "power-plants",
      filter: plant_label_visible,
      minzoom: 6,
    ...
    // Gas/Oil power plants - Labels
    {
      zorder: 270,
      id: "power-plant-gas-labels",
      type: "symbol" as const,
      source: "power-plants",
      filter: plant_label_visible,
      minzoom: 6,
    ...
    // Wind power plants - Labels
    {
      zorder: 270,
      id: "power-plant-wind-labels",
      type: "symbol" as const,
      source: "power-plants",
      filter: plant_label_visible,
      minzoom: 6,
    ...
    // Nuclear power plants - Icons
    {
      zorder: 267,
      id: "power-plant-nuclear-icons",
      type: "symbol" as const,
      source: "power-plants",
      maxzoom: 16,
      filter: [
      ...
      layout: {
        ...
        "symbol-z-order": "source",
        "icon-allow-overlap": true,
        "icon-image": "power_plant_nuclear",
        "icon-size": [
          "interpolate",
          ["linear"],
          ["zoom"],
    ...
    // Hydro power plants - Icons
    {
      zorder: 267,
      id: "power-plant-hydro-icons",
      type: "symbol" as const,
      source: "power-plants",
      maxzoom: 16,
      filter: [
    ...
    // Gas/Oil power plants - Icons
    {
      zorder: 267,
      id: "power-plant-gas-icons",
      type: "symbol" as const,
      source: "power-plants",
      maxzoom: 16,
      filter: [
    ...
    // Wind power plants - Icons
    {
      zorder: 267,
      id: "power-plant-wind-icons",
      type: "symbol" as const,
      source: "power-plants",
      maxzoom: 16,
      filter: [
